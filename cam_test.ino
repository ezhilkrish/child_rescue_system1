...
pinMode(5,OUTPUT);
    pinMode( 0, INPUT);
   Serial.println("                               *************************************The project Child Resuce System begigns************************* ");
   Serial.println(" ************************************************************************************************************************************************************************************************************************************");
Serial.print("\n The Child is to be rescued soon ");
Serial.print("\nPROCESS MONITORING THE INSIDE ENVORONMENT");
   ...
   /*if (distance > 10) {
    Serial.println("---CHILD NOT DETECTED-");
   }else{
...
char c = Serial.read();
 ...
 Serial.print("TEMPRATURE = ");
  ...
  Serial.println();
   ...
   sensorValue = analogRead(7);       // read analog input pin 0
...
{
if(c=='1' || c=='1'){                         
Serial.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!1!!!!____-THE HAND ROTATES_____");
...
if(c=='2' || c=='2'){                         
Serial.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!1!!!!____-THE HAND ROTATE____");
...
if(c=='3' || c=='3'){                         
Serial.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!1!!!!____THE HAND(1) BEND-!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11_____");
...
if(c=='4' || c=='4'){                         
Serial.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!1!!!!____-THE HAND 1 BEND-!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11_____");
...
if(c=='5' || c=='5'){                         
Serial.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!1!!!!____-THE HAND((2 BEND!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11_____");
...
if(c=="11" || c=='B'){                         
Serial.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!1!!!!____-BALLOON INFLATES-!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11_____");
...
Serial.println("!sssssssssstop____");
